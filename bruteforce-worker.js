...
importScripts(
  ...
  'src/optimizer/rotation.js?v=59',
  'src/optimizer/bus.js?v=59',
  'src/optimizer/placement.js?v=59',
  'src/optimizer/score.js?v=59',
  'src/optimizer/validate.js?v=59',
  'optimizer.js?v=59'
);
...
// isLayoutValid, tryAddWires, scoreLayout moved to src/optimizer/{validate,score}.js
